...
8. Is there a guide?
Included are 3 textfiles to help players
romance_guide.txt: Guide for specifically finishing the romance
soa_event_list.txt: full list of all events in the mod for SOA
tob_event_list.txt: full list of all events in the mod for TOB
...
---------------------
Added Chinese translation with thanks to zrw19880124 on the Beamdog forums

---------------------
This version is: 4.1.2
---------------------
Fixed saradush tavern scene not firing if you started romance from TOB and skipped SOA

---------------------
This version is: 4.1.1
---------------------
Fix one grammar sentence
Include guides to mod
